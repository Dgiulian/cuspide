...
export const metadata: Metadata = {
  ...
  description: "Contacta a Cuspide Bienes Raices. Estamos aquí para ayudarte a encontrar tu propiedad ideal en Neuquén y Rio Negro. Atención personalizada de lunes a sábado.",
  keywords: ["contacto", "bienes raices", "inmobiliaria", "Neuquén", "Rio Negro", "teléfono", "email"],
  openGraph: {
    title: "Contacto | Cuspide Bienes Raices",
    description: "Contacta a Cuspide Bienes Raices. Estamos aquí para ayudarte a encontrar tu propiedad ideal.",
    type: "website",
  },
  alternates: {
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center">
            <h1 className="text-4xl md:text-5xl font-bold tracking-tight mb-6">
              ¿Hablamos de tu <span className="text-primary">Próxima Propiedad</span>?
            </h1>
            <p className="text-xl text-muted-foreground leading-relaxed">
              Estamos aquí para ayudarte en cada paso del proceso. 
              Contáctanos y un asesor experto te responderá a la brevedad.
            </p>
          </div>
        </div>
      </section>
            ...
            <div>
              <div className="mb-8">
                ...
                <p className="text-muted-foreground">
                  ...
                  Tu consulta será atendida por un asesor especializado.
                </p>
              </div>
            ...
            <div className="space-y-6">
              <Card className="overflow-hidden">
                ...
                <CardContent className="p-0">
                  ...
                  <div className="p-6">
                    <h4 className="font-semibold text-lg mb-2">Cuspide Bienes Raices</h4>
              ...
              <Card>
                <CardHeader>
                  <CardTitle className="text-lg">¿Por qué Contactarnos?</CardTitle>
                </CardHeader>
                <CardContent>
                  <ul className="space-y-3">
                    <li className="flex items-start gap-3">
                      ...
                      <span className="text-sm text-muted-foreground">
                        <strong>Atención personalizada:</strong> Cada cliente es único y merece un servicio a medida.
                      </span>
                    </li>
                    <li className="flex items-start gap-3">
                      <div className="w-2 h-2 bg-primary rounded-full mt-2 flex-shrink-0" />
                      <span className="text-sm text-muted-foreground">
                        <strong>Respuesta rápida:</strong> Te contactamos en menos de 24 horas hábiles.
                      </span>
                    </li>
                    <li className="flex items-start gap-3">
                      <div className="w-2 h-2 bg-primary rounded-full mt-2 flex-shrink-0" />
                      <span className="text-sm text-muted-foreground">
                        <strong>Experiencia comprobada:</strong> Más de 500 familias han confiado en nosotros.
                      </span>
                    </li>
                    <li className="flex items-start gap-3">
                      <div className="w-2 h-2 bg-primary rounded-full mt-2 flex-shrink-0" />
                      <span className="text-sm text-muted-foreground">
                        <strong>Sin compromiso:</strong> Consulta gratuita sin ningún tipo de obligación.
                      </span>
                    </li>
                  </ul>
                </CardContent>
      ...
      <section className="bg-primary/5 py-16">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-muted-foreground text-lg mb-8 max-w-2xl mx-auto">
            Déjanos tu número y un asesor te contactará en el horario que prefieras.
          </p>
